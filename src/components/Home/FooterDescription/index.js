              ...
              <Col span={24} md={6}>
                  ...
                  <Row type={'flex'}>
                      <Col>
                          ...
                          <Row>
                              <Button shape={'circle'} icon="facebook" href={"https://www.facebook.com/classbox.agency/"}/>
                              <Button shape={'circle'} icon="instagram" href={"https://www.instagram.com/classboxagency/"}/>
                              <Button shape={'circle'} icon="linkedin" href={"https://www.linkedin.com/company/20497683"}/>
                          </Row>
                      </Col>
                  </Row>
              </Col>
